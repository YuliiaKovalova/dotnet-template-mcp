...
internal sealed class TemplateSearchTool
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        IEnumerable<Microsoft.TemplateEngine.Abstractions.ITemplateInfo> filtered = allTemplates;
    ...
    /// </summary>
    private static double CalculateRelevance(Microsoft.TemplateEngine.Abstractions.ITemplateInfo template, string? query)
    {
        if (string.IsNullOrWhiteSpace(query))
        {
